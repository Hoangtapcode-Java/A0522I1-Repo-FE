...
@Component({
  selector: 'app-header-for-article',
  templateUrl: './header-for-article.component.html',
  styleUrls: ['./header-for-article.component.css']
})
export class HeaderForArticleComponent implements OnInit {
